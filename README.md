# Fork from erinlin/PureMVC-Unity-Demo
I made this fork from [erinlin/PureMVC-Unity-Demo](https://github.com/erinlin/PureMVC-Unity-Demo) to test my PureMVC fork for Unity [skibitsky/UnityPureMVC](https://github.com/skibitsky/UnityPureMVC). I changed the library in `/Plugins` and some minor changes.
